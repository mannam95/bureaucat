...
VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9, sqlc.narg('parent_task_id'), sqlc.narg('figma_link'), sqlc.narg('branch'), sqlc.narg('pull_request'), COALESCE(sqlc.narg('priority_rating'), 0))
