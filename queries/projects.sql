...
VALUES ($1, $2, $3, $4, $5, $6, $7, COALESCE(sqlc.narg('originator_id')::uuid, $7), $8, $9, sqlc.narg('parent_task_id'), sqlc.narg('figma_link'), sqlc.narg('branch'), sqlc.narg('pull_request'), COALESCE(sqlc.narg('priority_rating'), 0))
...
SET title = COALESCE(sqlc.narg('title'), title),
    ...
    originator_id = COALESCE(sqlc.narg('originator_id'), originator_id),
    updated_at = NOW()
WHERE id = $1 AND deleted_at IS NULL
